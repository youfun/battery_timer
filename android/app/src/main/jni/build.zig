// build.zig — Android native build for battery_timer.
//
...
//     Output: libbattery_timer.so installed to
//     android/app/src/main/jniLibs/<abi>/libbattery_timer.so so
